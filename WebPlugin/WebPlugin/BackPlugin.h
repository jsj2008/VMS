...
#ifndef _BACK_PLUGIN_H__
#define _BACK_PLUGIN_H__
...
class VMSBackPluginImpl;

class CBackPlugin : public VMSBackPluginEvent
{
private:
  NPP m_pNPInstance;
...
public:
	...
	void AsyncPlayProgress() ;
public:
  CBackPlugin(NPP pNPInstance);
  ~CBackPlugin();
